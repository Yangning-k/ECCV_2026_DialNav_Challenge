...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default='holistic', choices=['navonly', 'holistic'])
    ...
    parser.add_argument('--wta_mode', type=str, default='ct_0.6_cap_3')
    parser.add_argument('--nav_model', type=str, default='DST', choices=['ScaleVLN', 'DST'])
    ...
    parser.add_argument('--loc_conf_threshold', type=float, default=0.0,
                        help='Skip navigator instruction updates when GTL '
                             'localization confidence is below this value '
                             '(0 = disabled).')

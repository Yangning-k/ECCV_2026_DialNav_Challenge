...
class VLNDialogDataset(Dataset):
    ...
    def _load_rain_data(self, data_path, debug=False):
        ...
        for idx, item in enumerate(data):
            ...
            if 'neighbor_viewpoint_list' in item:
                processed_item['neighbor_viewpoint_list'] = item['neighbor_viewpoint_list']
...
# tokenizer = BertTokenizer.from_pretrained(os.environ["DIALNAV_BERT_TOKENIZER_DIR"])

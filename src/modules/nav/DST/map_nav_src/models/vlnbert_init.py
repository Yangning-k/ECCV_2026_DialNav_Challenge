...
def get_vlnbert_models(args, config=None, wta=False):
    # print("get_vlnbert_models", args)
    
    from transformers import PretrainedConfig
    from models.vilmodel import GlocalTextPathNavCMT, GlocalTextPathNavCMTWTA
    ...
    if wta: 
        visual_model = GlocalTextPathNavCMTWTA.from_pretrained(
